...
**Rendimiento de laboratorio (12/09/2026):** Lighthouse móvil contra producción pasó de 41/100 (FCP 4,4 s, LCP 7,8 s, TBT 670 ms) a una mediana de 89/100 en tres ejecuciones de la versión actual (FCP 1,9 s, LCP 2,8 s, CLS 0, TBT 300 ms), al evitar el runtime de AdSense cuando no hay slots y alojar las tipografías localmente. El control local alcanzó una mediana de 99/100 (FCP 1,5 s, LCP 2,1 s, CLS 0, TBT 0 ms). Son mediciones de laboratorio; el criterio de salida sigue siendo P75 de usuarios reales.
