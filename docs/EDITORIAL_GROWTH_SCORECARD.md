...
Las siete páginas prioritarias también tienen ahora dos enlaces contextuales dentro del cuerpo, además de las tarjetas relacionadas. Las 25 restantes no se enlazan automáticamente: se añadirán solo cuando el editor confirme que el destino aporta contexto y no canibaliza la consulta.
...
El catálogo actual contiene 314 entradas y la biblioteca 84 briefs. La segunda búsqueda enfocada de Luna añadió 25 fuentes no duplicadas y priorizó siete oportunidades conectadas a las consultas observadas; las tandas siguientes ampliaron clústeres de revisión y la verificación en navegador del 12/09 añadió tres registros abiertos para geodinamo, pulpo mimo y geosmina, además de cinco controles oficiales de Google sobre IA, imágenes, títulos/snippets y preparación de AdSense. Todas siguen siendo candidatas hasta la comprobación humana. Las familias nuevas más útiles son:
