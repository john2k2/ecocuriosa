...
El catálogo actual contiene 293 entradas y la biblioteca 72 briefs. La segunda búsqueda enfocada de Luna añadió 25 fuentes no duplicadas y priorizó siete oportunidades conectadas a las consultas observadas; la tanda siguiente añadió diez fuentes para seis clústeres de revisión, la búsqueda del 12/09 añadió doce fuentes para ocho temas de evidencia y esta revisión añadió catorce fuentes para ocho temas prioritarios. Todas siguen siendo candidatas hasta la comprobación humana. Las familias nuevas más útiles son:
