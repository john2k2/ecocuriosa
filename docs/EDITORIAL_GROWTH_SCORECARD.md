...
**Rendimiento de laboratorio (12/09/2026):** Lighthouse móvil contra producción pasó de 41/100 (FCP 4,4 s, LCP 7,8 s, TBT 670 ms) a 84/100 (FCP 3,3 s, LCP 3,3 s, TBT 0 ms) al evitar el runtime de AdSense cuando no hay slots configurados, y a 88/100 en la versión actual con tipografías locales (FCP 2,9 s, LCP 3,2 s, CLS 0,002, TBT 0 ms). Un control local alcanzó 97/100 (FCP 2,0 s, LCP 2,1 s, CLS 0,001). Son mediciones de laboratorio; el criterio de salida sigue siendo P75 de usuarios reales.
