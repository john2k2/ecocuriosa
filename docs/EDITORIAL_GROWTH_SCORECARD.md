...
**Refresco de entrega (14/09/2026):** la primera lectura de Cloudflare Edge registró 11.626 solicitudes y 165.859.122 bytes del 8–14/09 (el día 14 incompleto), con 1.998 solicitudes en caché (17,2 %) y 53.334.804 bytes en caché (32,2 %). Una segunda lectura autenticada del mismo intervalo registró 13.025 solicitudes y 181.466.516 bytes, con 2.083 solicitudes en caché (16,0 %) y 55.204.565 bytes en caché (30,4 %). El 14/09 seguía en curso; ambas lecturas son señales de edge que mezclan bots, recursos y redirecciones, no audiencia humana. El detalle diario está en [`CLOUDFLARE_EDGE_SNAPSHOT_2026-09-14.md`](editorial/CLOUDFLARE_EDGE_SNAPSHOT_2026-09-14.md).
