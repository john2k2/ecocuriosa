...
| Indexación | Sitemap con 44 páginas descubiertas en la última lectura autenticada; la propiedad todavía está procesando cobertura | El 14/09 se reenvió `sitemap-index.xml` y se solicitó una indexación individual de `/correcciones/`; esperar el rastreo y luego inspeccionar portada, categorías, cinco artículos prioritarios y páginas de confianza en Search Console | Cada URL canónica tiene estado explicado; exclusiones no deseadas corregidas y sitemap actualizado | Titular de Search Console |
...
| Audiencia orgánica | 340 impresiones, 2 clics, CTR 0,6 % y posición media 12 en la lectura del 14/09; consultas principales: architeuthis dux, pulpo mimo y geodinamo | Testear una hipótesis de título/extracto por página con impresiones, no crear duplicados; conservar el detalle en [`SEARCH_CONSOLE_SNAPSHOT_2026-09-14.md`](editorial/SEARCH_CONSOLE_SNAPSHOT_2026-09-14.md) | Comparación fechada de CTR, posición, país, dispositivo y páginas por sesión; sin atribuir causalidad con muestras pequeñas | Editor de crecimiento |
