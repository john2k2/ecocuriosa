...
| Indexación | Sitemap con 43 páginas descubiertas en la última lectura autenticada; la propiedad todavía está procesando cobertura | El 14/09 se reenvió `sitemap-index.xml` después de publicar `/correcciones/`; esperar la nueva lectura y luego inspeccionar portada, categorías, cinco artículos prioritarios y páginas de confianza en Search Console | Cada URL canónica tiene estado explicado; exclusiones no deseadas corregidas y sitemap actualizado | Titular de Search Console |
