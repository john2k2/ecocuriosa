...
| :--- | :--- | :--- |
| Actividad eléctrica | Muy elevada, con variación estacional e interanual | Debe leerse junto con el período y el sensor empleado |
| Tormentas | Frecuentes en la región, no permanentes | Los episodios dependen de las condiciones atmosféricas |
| Destellos visibles | Pueden observarse a gran distancia | La visibilidad no permite calcular por sí sola la tasa de rayos |
| Nubes convectivas | Pueden alcanzar gran desarrollo vertical | La altura depende de cada tormenta |

---

## 3. Desmintiendo Mitos Comunes

* **Mito 1:** El fenómeno se debe exclusivamente al metano de los humedales.
...
No hay base para atribuirle una cifra global como “10 %”. Los rayos intervienen en química atmosférica local, pero eso no convierte al Catatumbo en un reparador de la capa de ozono.
