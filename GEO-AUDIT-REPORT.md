...
- Producción muestreada: portada, artículos con referencias trazables, búsqueda, páginas legales, metodología, `robots.txt`, `ads.txt`, `llms.txt`, feed RSS, sitemap, las 96 imágenes (`jpg`, `svg` y `webp`), las tres tipografías locales, redirección `www` y beacon de Cloudflare Web Analytics inyectado por Pages. El despliegue vigente verificado `d72257ce-fe06-4cf9-af9e-f3c27150dbee`, generado desde el commit `a115980`, terminó con build y deploy exitosos y mantiene los alias `https://ecocuriosa.com` y `https://www.ecocuriosa.com`. La comprobación pública devolvió 200 para la portada, el artículo de manta raya, `rss.xml`, `llms.txt`, el sitemap de imágenes (32/32), `ads.txt` y las variantes SVG/WebP de los artículos muestreados.
