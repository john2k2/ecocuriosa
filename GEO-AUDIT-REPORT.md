...
- `pnpm content:link-audit`: 46 documentos HTML y 111 enlaces/recursos internos comprobados (incluye `srcset` de las imágenes); 0 rutas faltantes. El control quedó integrado en `.github/workflows/content-quality.yml`.
