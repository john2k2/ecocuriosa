...
- Producción muestreada: portada, artículos con referencias trazables, búsqueda, páginas legales, metodología, `robots.txt`, `ads.txt`, `llms.txt`, feed RSS, sitemap, las 96 imágenes (`jpg`, `svg` y `webp`), las tres tipografías locales, redirección `www` y beacon de Cloudflare Web Analytics inyectado por Pages. El despliegue vigente verificado `67615aa7-b1bd-4321-b6af-ffad997c1df6`, generado desde el commit `0998c50`, terminó con build y deploy exitosos y mantiene los alias `https://ecocuriosa.com` y `https://www.ecocuriosa.com`. La comprobación pública devolvió 200 para la portada, los ocho artículos refinados en esta ronda, `rss.xml`, `llms.txt`, el sitemap de imágenes (32/32), `ads.txt` y las variantes SVG/WebP de los artículos muestreados.
