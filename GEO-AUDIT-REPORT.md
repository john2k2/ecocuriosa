...
- Producción muestreada: portada, artículos con referencias trazables, búsqueda, páginas legales, metodología, `robots.txt`, `ads.txt`, `llms.txt`, sitemap, las 96 imágenes (`jpg`, `svg` y `webp`), las tres tipografías locales, redirección `www` y beacon de Cloudflare Web Analytics inyectado por Pages. El despliegue más reciente `4e7fda29-11c5-460b-a6ee-244c682e85f0`, generado desde el commit `72de5c83747cc64f3c282dad3aa5c87ae683c7e9` (que incluye el código de procedencia del commit `44f79ff8f005b64bc9dce1fa8f0e92f8888b16c6`), terminó con build y deploy exitosos y mantiene los alias `https://ecocuriosa.com` y `https://www.ecocuriosa.com`. La comprobación pública devolvió 200 para la portada, el artículo de geodinamo, `llms.txt`, el sitemap de imágenes (32/32) y las variantes SVG/WebP del axolote.
