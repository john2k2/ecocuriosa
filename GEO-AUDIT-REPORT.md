...
- Producción muestreada: portada, artículos con referencias trazables, búsqueda, páginas legales, metodología, `robots.txt`, `ads.txt`, `llms.txt`, feed RSS, sitemap, las 96 imágenes (`jpg`, `svg` y `webp`), las tres tipografías locales, redirección `www` y beacon de Cloudflare Web Analytics inyectado por Pages. El despliegue más reciente `1f71c73c-56c2-40fc-beb2-42ebd6710206`, generado desde el commit `6408793f518ee0cf34290fdfb372544f36c26eff` (que incluye el código de procedencia de los commits `44f79ff8f005b64bc9dce1fa8f0e92f8888b16c6`, `9cdc8e960f2187e3ea8984e449a6313f8b637da7` y `509d12298513a771d19ebd7699c0e7ed8ee3b8f6`), terminó con build y deploy exitosos y mantiene los alias `https://ecocuriosa.com` y `https://www.ecocuriosa.com`. La comprobación pública devolvió 200 para la portada, el artículo de geodinamo, `rss.xml`, `llms.txt`, el sitemap de imágenes (32/32) y las variantes SVG/WebP del axolote.
