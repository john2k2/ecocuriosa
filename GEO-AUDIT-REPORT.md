...
- `pnpm content:indexation-audit`: comprueba los 32 artículos publicados, su HTML y canonical, su aparición única en el sitemap (32/32), las 43 URLs totales, `Allow: /`, el sitemap canónico y el `noindex` de búsqueda/404; no detecta problemas. El control quedó integrado en `.github/workflows/content-quality.yml`.
