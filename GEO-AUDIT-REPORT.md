...
- Producción muestreada: portada, artículos con referencias trazables, búsqueda, páginas legales, metodología, `robots.txt`, `ads.txt`, `llms.txt`, feed RSS, sitemap, las 96 imágenes (`jpg`, `svg` y `webp`), las tres tipografías locales, redirección `www` y beacon de Cloudflare Web Analytics inyectado por Pages. El despliegue vigente verificado `c08fb011-d61b-4d4c-ac6d-5f856adee2bb`, generado desde el commit `cc0c603`, terminó con build y deploy exitosos y mantiene los alias `https://ecocuriosa.com` y `https://www.ecocuriosa.com`. La comprobación pública devolvió 200 para la portada, los artículos actualizados de manta raya, coral y peces linterna, `rss.xml`, `llms.txt`, el sitemap de imágenes (32/32), `ads.txt` y las variantes SVG/WebP de los artículos muestreados.
