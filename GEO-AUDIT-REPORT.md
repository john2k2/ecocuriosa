...
- Producción muestreada: portada, artículos con referencias trazables, búsqueda, páginas legales, metodología, `robots.txt`, `ads.txt`, `llms.txt`, sitemap, las 96 imágenes (`jpg`, `svg` y `webp`), las tres tipografías locales, redirección `www` y beacon de Cloudflare Web Analytics inyectado por Pages. El despliegue más reciente `29cdcb5d-996c-4f66-81de-1657725b0dba`, generado desde el commit `b963e851b517bc22217dac035ddbb54ff34f7ca5` (que incluye el código de procedencia de los commits `44f79ff8f005b64bc9dce1fa8f0e92f8888b16c6` y `9cdc8e960f2187e3ea8984e449a6313f8b637da7`), terminó con build y deploy exitosos y mantiene los alias `https://ecocuriosa.com` y `https://www.ecocuriosa.com`. La comprobación pública devolvió 200 para la portada, el artículo de geodinamo, `llms.txt`, el sitemap de imágenes (32/32) y las variantes SVG/WebP del axolote.
