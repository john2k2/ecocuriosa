...
- Producción muestreada: portada, artículos con referencias trazables, búsqueda, páginas legales, metodología, `robots.txt`, `ads.txt`, `llms.txt`, feed RSS, sitemap, las 96 imágenes (`jpg`, `svg` y `webp`), las tres tipografías locales, redirección `www` y beacon de Cloudflare Web Analytics inyectado por Pages. El despliegue final verificado `464f01f9-207b-4c3f-b20f-fb2464e9d2be`, generado desde el commit `b9d42a7ef265d2c68fee2fc6e16333e25b751e6b`, terminó con build y deploy exitosos y mantiene los alias `https://ecocuriosa.com` y `https://www.ecocuriosa.com`. La comprobación pública devolvió 200 para la portada, el artículo de geodinamo, `rss.xml`, `llms.txt`, el sitemap de imágenes (32/32), `ads.txt` y las variantes SVG/WebP del geodinamo.
