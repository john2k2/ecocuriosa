...
- Producción muestreada: portada, artículo, búsqueda, páginas legales, metodología, `robots.txt`, `ads.txt`, sitemap, redirección `www` y beacon de Cloudflare Web Analytics inyectado por Pages. La verificación de producción de los cambios de interfaz asociada a `8895becdc2e8c745c4b61089ddc799da6d40d67f` terminó correctamente como `2b555c9f-be8d-466e-8198-f4ea50ca8e0c`; los commits posteriores solo actualizan documentación y controles de CI, y mantienen los alias `https://ecocuriosa.com` y `https://www.ecocuriosa.com`.
