...
- `pnpm content:source-metadata-audit`: las 96 fuentes del archivo tienen editor, URL, tipo de evidencia y alcance declarado (96/96); el control quedó integrado en `.github/workflows/content-quality.yml` para evitar que una nueva ficha pierda contexto editorial.
...
- `pnpm content:image-sitemap-audit`: 32/32 páginas de artículo tienen una entrada `image:image` con la variante WebP, título y pie contextual; el control quedó integrado en `.github/workflows/content-quality.yml`.
...
- Producción muestreada: portada, artículos con referencias trazables, búsqueda, páginas legales, metodología, `robots.txt`, `ads.txt`, `llms.txt`, feed RSS, sitemap, las 96 imágenes (`jpg`, `svg` y `webp`), las tres tipografías locales, redirección `www` y beacon de Cloudflare Web Analytics inyectado por Pages. El despliegue funcional verificado `dcdbbad9-4463-4c22-af5f-43106061dd90`, generado desde el commit `62016d8dc825798869b9381720988eb8a227d0f5` (que incluye el código de procedencia de los commits `44f79ff8f005b64bc9dce1fa8f0e92f8888b16c6`, `9cdc8e960f2187e3ea8984e449a6313f8b637da7` y `509d12298513a771d19ebd7699c0e7ed8ee3b8f6`), terminó con build y deploy exitosos y mantiene los alias `https://ecocuriosa.com` y `https://www.ecocuriosa.com`. La comprobación pública devolvió 200 para la portada, el artículo de geodinamo, `rss.xml`, `llms.txt`, el sitemap de imágenes (32/32) y las variantes SVG/WebP del axolote.
