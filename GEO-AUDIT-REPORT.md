...
- Producción muestreada: portada, artículos con referencias trazables, búsqueda, páginas legales, metodología, `robots.txt`, `ads.txt`, `llms.txt`, sitemap, las 96 imágenes (`jpg`, `svg` y `webp`), las tres tipografías locales, redirección `www` y beacon de Cloudflare Web Analytics inyectado por Pages. El despliegue de Pages `f54ad068-895e-4602-9893-b066e4155031`, generado desde el commit `4ccf9d4a9973bebb7018e22796f92a95762304e7`, terminó con build y deploy exitosos y mantiene los alias `https://ecocuriosa.com` y `https://www.ecocuriosa.com`. La comprobación pública devolvió 200 para la portada, tres artículos representativos, `llms.txt` y variantes SVG/WebP del axolote.
