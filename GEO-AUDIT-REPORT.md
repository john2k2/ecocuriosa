...
- Producción muestreada: portada, artículos con referencias trazables, búsqueda, páginas legales, metodología, `robots.txt`, `ads.txt`, `llms.txt`, sitemap, las 96 imágenes (`jpg`, `svg` y `webp`), las tres tipografías locales, redirección `www` y beacon de Cloudflare Web Analytics inyectado por Pages. El despliegue de aplicación que contiene estas mejoras `86236c47-540e-4161-8453-2fc30f9178c5`, generado desde el commit `90a98afd7ffe3730731f96d99867ab8fefe2460d`, terminó con build y deploy exitosos y mantiene los alias `https://ecocuriosa.com` y `https://www.ecocuriosa.com`. La comprobación pública devolvió 200 para la portada, tres artículos representativos, `llms.txt`, el sitemap de imágenes (32/32) y variantes SVG/WebP del axolote.
