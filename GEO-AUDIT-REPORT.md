...
su copia de repositorio), por lo que la ficha actual declara 100 URLs. Los estados `203/403` se
...
- `pnpm content:source-render-audit`: las 32 fichas construidas exponen las 100 URLs de fuente del frontmatter como enlaces visibles en el HTML; 0 rutas de artículo ausentes y 0 fuentes omitidas. El control quedó integrado en `.github/workflows/content-quality.yml`.
- `pnpm content:source-metadata-audit`: las 100 fuentes del archivo tienen editor, URL, tipo de evidencia y alcance declarado (100/100); el control quedó integrado en `.github/workflows/content-quality.yml` para evitar que una nueva ficha pierda contexto editorial.
- `pnpm content:reference-audit`: las 100 fuentes del frontmatter también aparecen como enlaces exactos en el cuerpo de sus artículos (100/100); el control evita bibliografías genéricas o fuentes registradas que el lector no pueda rastrear.
