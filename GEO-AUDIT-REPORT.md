...
- Producción muestreada: portada, artículo, búsqueda, páginas legales, metodología, `robots.txt`, `ads.txt`, sitemap, redirección `www` y beacon de Cloudflare Web Analytics inyectado por Pages. El despliegue vigente de Pages asociado a `7f37b87f5e234643f7b1145ae9fa138658756714` terminó correctamente como `c97b9f33-551e-4230-bf85-35b43d003f27` y mantiene los alias `https://ecocuriosa.com` y `https://www.ecocuriosa.com`.
