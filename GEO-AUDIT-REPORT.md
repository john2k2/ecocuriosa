...
- `pnpm content:source-metadata-audit`: las 103 fuentes del archivo tienen editor, URL, tipo de evidencia y alcance declarado (103/103); el control quedó integrado en `.github/workflows/content-quality.yml` para evitar que una nueva ficha pierda contexto editorial.
